...
public class CheckEmptyTest
{
    ...
    @Test(description="check value is empty", groups = { "testempty", "beforefix"}, dataProvider = "testDP")
    ...
    @Test(description="check value is empty no DP", groups = {"testempty", "testemptynodp", "beforefix"})
